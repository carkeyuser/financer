...
echo "  scp $OUT root@YOUR_SERVER:/opt/financer/"
echo ""
echo "Erstmalig auf dem Server:"
echo "  ssh root@YOUR_SERVER"
echo "  mkdir -p /opt/financer && cd /opt/financer"
...
echo "  scp $OUT root@YOUR_SERVER:/opt/financer/"
echo "  ssh root@YOUR_SERVER 'cd /opt/financer && tar xzf finance_deploy.tar.gz && ./deploy.sh'"
